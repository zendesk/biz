RSpec.describe Biz::WeekTime::Abstract do
  ...
  describe "#wday" do
    context "when the time is contained within a day" do
      subject(:week_time) {
        week_time_class.new(week_minute(wday: 0, hour: 12))
      }
    ...
    context "when the time is on a day boundary" do
      subject(:week_time) {
        week_time_class.new(week_minute(wday: 1, hour: 0))
      }
    ...
    context "when the time is the last minute of the week" do
      subject(:week_time) {
        week_time_class.new(week_minute(wday: 7, hour: 0))
      }
  ...
  describe "#week" do
    ...
    context "when the time is the first minute of the week" do
      subject(:week_time) { week_time_class.new(week_minute(wday: 0, hour: 0)) }
    ...
    context "when the time is in the middle of the week" do
      subject(:week_time) {
        week_time_class.new(week_minute(wday: 4, hour: 18))
      }
    ...
    context "when the time is the last minute of the week" do
      subject(:week_time) { week_time_class.new(week_minute(wday: 7, hour: 0)) }
